...
* recode communication consent checklist to be compatible with odds ratio
...
* recode preop checks
foreach i of varlist prep_preop prep_machine prep_airwaychecked prep_suction prep_neonatal {
	gen `i'2 = 0 if `i' == 2
	replace `i'2 = 1 if `i' == 1
	label define `i'__ 0 "No" 1 "Yes"
	label values  `i' `i'__
...
* and recode spinal checks

foreach i of varlist spinal_sterile spinal_wedge spinal_height-spinal_abx {
	gen `i'2 = 0 if `i' == 2
	replace `i'2 = 1 if `i' == 1
	label define `i'__ 0 "No" 1 "Yes"
	label values  `i' `i'__
...
file open fh using output.txt, write append
file write fh "prep_neonatal" _tab "checks prep_neonatal" _tab (r(chi2)) _tab
mata: o = st_matrix("o")
mata: st_matrix("e", (rowsum(o)* colsum(o)) / sum(o)) 
mata: mata clear
